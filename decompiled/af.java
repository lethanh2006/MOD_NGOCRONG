...
implements bq {
    ...
    static {
        k = l.b("/mainImage/myTexture2dat-trai-dat.png");
        l = l.b("/mainImage/myTexture2dmat-namek.png");
        br = new Vector();
        bs = (short)30000;
        n = l.b("/mainImage/myTexture2dthucuoi10.png");
        df = l.b("/mainImage/myTexture2dthucuoi20.png");
        dg = l.b("/mainImage/myTexture2dthucuoi21.png");
        dh = l.b("/mainImage/myTexture2dthucuoi30.png");
        di = l.b("/mainImage/myTexture2dthucuoi11.png");
        dj = l.b("/mainImage/myTexture2dthucuoi22.png");
        dk = l.b("/mainImage/myTexture2dthucuoi23.png");
        dl = l.b("/mainImage/myTexture2dthucuoi31.png");
        dm = l.b("/mainImage/myTexture2drong.png");
        dn = l.b("/mainImage/myTexture2dcanhrong.png");
    ...
    public final void b() {
        try {
            ...
            while (n3 >= 0) {
                if (this.y >= p.R[n3]) {
                    l2 = n3 == p.R.length - 1 ? 1L : p.R[n3 + 1] - p.R[n3];
                    l3 = this.y - p.R[n3];
                    n2 = n3;
                    break;
                }
    ...
    public static void a(boolean bl2) {
        ai ai2 = af.e().aD;
        String string = ai2.g[ai2.a];
        if (string != null && !string.equals("")) {
            if (string.startsWith("#")) {
                string = ai.a(string, "#", "");
                do do_ = new do(5, 0, -100, -100, 5, p.aD.a[af.e().K][2]);
                do_.C = -100;
                new do(5, 0, -100, -100, 5, p.aD.a[af.e().K][2]).B = -100;
                do_.aO = p.aD.a[af.e().K][2];
                do_.J = 5;
                if (main.a.E == p.c) {
                    ae.a(string, do_);
                }
        ...
        g.as = ai2.c >= 0;
        main.a.G.D = ai2.c < 12 ? aw.aN : aw.aO;
        main.a.G.M[0] = main.a.G.D;
        if (af.dD.aD.c > 10) {
            eu.a("fake", "aa");
        }
    }
    ...
    public final bf a(et et2) {
        ...
        while (n2 < this.az.size()) {
            if (((bf)this.az.elementAt((int)n2)).a.a == et2.a) {
    ...
    public final bw i() {
        ...
        while (n3 < n2) {
            ...
            if (this.B >= bw2.a && this.B <= bw2.c && this.C >= bw2.b && this.C <= bw2.d && bw2.e && bw2.f) {
                return bw2;
            }
            n3 = (byte)(n3 + 1);
        }
    ...
    private boolean ac() {
        ...
        while (n3 < n2) {
            bw bw2 = (bw)bv.t.elementAt(n3);
            if ((bv.l == 47 || bv.f()) && this.C <= bw2.b + bw2.d && this.B > bw2.a && this.B < bw2.c) {
                return !bv.f() || this.aN == 0;
            }
            if (this.B >= bw2.a && this.B <= bw2.c && this.C >= bw2.b && this.C <= bw2.d && !bw2.e) {
                return true;
            }
            n3 = (byte)(n3 + 1);
        }
    ...
    private void ad() {
        boolean bl2;
        if (this.aq && this.H == 10 && this.as == 8 && this.dP > 20 && main.a.w % 20 == 0) {
            bu.a();
        }
        ...
        if (!this.aq) {
            if (this.aq) return;
            if (this.B < p.j) return;
            if (this.B > p.j + main.a.A) return;
        }
        if (main.a.w % 5 != 0) return;
    ...
    public void a() {
        block274: {
            block273: {
                ...
                if (this.v != null) {
                    ...
                    if (main.a.w % 3 == 0) {
                        var1_1.c = var1_1.o[var1_1.p];
                        ++var1_1.p;
                    }
                    if (var1_1.p >= var1_1.o.length) {
                        var1_1.p = 0;
                    }
                }
                ...
                if (this.db) {
                    if (main.a.b > this.fl || this.H == 14 || this.H == 5) {
                        this.fl = 0L;
                        this.db = false;
                    }
                    var1_1 = this;
                ...
                if (this.eG) {
                    if (this.dJ == null && (var1_1 = (String)main.a.T.get(String.valueOf(this.J))) != null) {
                        var2_15 = ds.a(var1_1.trim(), ",", 0);
                        var3_21 = Short.parseShort(var2_15[0]);
                        var1_4 = Short.parseShort(var2_15[1]);
                        this.dJ = new ea(var3_21, this.B, this.eB + 73, 1, -1, -1);
                        this.dJ.l = (long)(var1_4 * 1000) + l.d();
                    }
                    if (this.dJ != null) {
                        this.dJ.a();
                        this.dJ.f = this.B;
                        ...
                        if (this.dJ.l <= l.d()) {
                            this.dJ = null;
                            main.a.T.remove(String.valueOf(this.J));
                        }
                    }
                }
                ...
                if (this.eH) {
                    ...
                    if (this.eI == 1) {
                        ...
                        this.d = 0;
                        this.F = 0;
                        ds.c("set pox x= " + this.eJ + " y= " + this.eK);
                        if (this.eL == 1) {
                            if (this.aq) {
                                this.bD = this.B;
                                this.bE = this.C;
                ...
                if (this.cj) {
                    ++this.em;
                    var1_6 = bv.a(af.e().B, af.e().C, 2) == false;
                    this.ae();
                    this.ah();
                    this.aZ = null;
                    this.bP = null;
                    ...
                    if (this.K == 2) {
                        if (bv.l == 170) {
                            ...
                            if (main.a.w % 5 == 0) {
                                at.a(114, this.B + ds.b(-20, 20), this.C + ds.b(-20, 20), 1);
                            }
                        }
                    }
                    if (this.K == 1 && main.a.w % 2 == 0) {
                        if (this.I == 1) {
                            at.a(70, this.B - 18, this.C - this.al / 2 + 8, 1);
                            at.a(70, this.B + 23, this.C - this.al / 2 + 15, 1);
                        } else {
                    ...
                    if (this.m - this.bo > (long)this.bm || this.m - this.bo > 10000L) {
                        ...
                        if (this.aq) {
                            if (this.K == 2) {
                                ds.c("<*> 9 [me] xay da xong  " + af.e().aC.b);
                                af.e().a(p.u[af.e().aC.b], var1_6 == false ? 0 : 1);
                            }
                            if (this.K == 1) {
                                ds.c("<*> 9 [me] namec xong " + af.e().aC.b);
                                this.ce = true;
                                af.e().a(p.u[af.e().aC.b], var1_6 == false ? 0 : 1);
                            }
                            if (this.K == 0) {
                            ...
                            if (af.e().aC.b >= 77 && af.e().aC.b <= 83) {
                                bt.a().c((byte)4);
                            }
                            var2_16 = af.e().aC.b;
                        } else {
                            if (this.K == 2) {
                                this.a(p.u[this.aP], var1_6 == false ? 0 : 1);
                ...
                if (this.ci) {
                    ...
                    if (this.el > 20) {
                        ...
                        if (this.m - this.bo > (long)this.bm || this.m - this.bo > 10000L) {
                            ...
                            if (this.aq) {
                                this.ce = true;
                                var1_7 = bv.a(af.e().B, af.e().C, 2);
                                this.ch = true;
                                this.a(p.u[af.e().aC.b], var1_7 != false ? 0 : 1);
                                return;
                            }
                            if (bv.l == 170) {
                                this.ce = true;
                                ...
                                this.a(p.u[this.aP], var1_8 != false ? 0 : 1);
                            }
                            return;
                        }
                        this.as = 32;
                        if (this.K == 0 && main.a.w % 3 == 0) {
                            at.a(153, this.B, this.C - this.al, 2);
                        }
                        if (bv.l == 170 && (this.K == 2 || this.K == 1) && main.a.w % 3 == 0) {
                            at.a(153, this.B, this.C - this.al, 2);
                        }
                        ++this.em;
                        if (this.em == 500) {
                ...
                if (this.aq && main.a.e) {
                    if (this.aU != null && this.aU.J >= 0 && this.aU.B > 100 && this.aU.B < bv.c - 100 && this.j() == null && this.i() == null && !this.I() && bv.l != 51 && bv.l != 52 && main.a.G.S.size() > 0 && p.j().bQ == null) {
                        var1_9 = Math.abs(this.B - this.aU.B);
                        var2_17 = Math.abs(this.C - this.aU.C);
                        if (var1_9 < 60 && var2_17 < 40) {
                            if (this.an == null) {
                                this.an = new de(aw.bi, 11111);
                                this.an.f = false;
                            }
                            this.an.j = this.aU.B - p.j;
                            this.an.k = this.aU.C - this.aU.al - 30 - p.k;
                        } else {
                            this.an = null;
                        }
                    } else {
                ...
                if (this.U > 0L) {
                    ...
                    if (this.R > 0 && main.a.z) {
                        this.U += (long)this.R;
                    }
                    if (this.S > 0 && main.a.z) {
                        this.T += (long)this.S;
                    }
                    if (this.U > this.V) {
                        this.U = this.V;
                ...
                if (this.aU != null && !p.D.contains(this.aU)) {
                    this.aU = null;
                }
                if (this.B < 10) {
                    this.D = 0;
                ...
                if (this.bP != null) {
                    if (af.c(this.B - this.bP.a) <= 16 && af.c(this.C - this.bP.b) <= 16) {
                        ...
                        if (bv.a(this.B, this.C, 2)) {
                            ...
                            if (this.bP.b < this.C + 10) {
                                this.H = 10;
                                this.E = -5;
                                if (af.c(this.C - this.bP.b) <= 10) {
                                    this.C = this.bP.b;
                                    this.E = 0;
                                }
                                this.D = af.c(this.B - this.bP.a) <= 10 ? 0 : this.O * this.I;
            ...
            if (af.c(this.bP.a - this.B) < 17 && af.c(this.bP.b - this.C) < 25) {
                this.B = this.bP.a;
                this.C = this.bP.b;
                this.bP = null;
                if ((bv.b(this.B, this.C) & 2) == 2) {
            ...
            if (var1_12 && this.bF.size() > 0) {
                ...
                if (this.bP.c == 2) {
                    ...
                    if ((bv.b(this.B, this.C + 23) & 2) != 2) {
                        ...
                        this.D = af.c(this.B - this.bP.a) / 10 * this.I;
                        this.E = -10;
                    }
                } else if (this.bP.c == 4) {
                    this.H = 4;
                    ...
                    this.D = af.c(this.B - this.bP.a) / 9 * this.I;
                    this.E = 0;
                } else {
                    this.B = this.bP.a;
                    this.C = this.bP.b;
        ...
        switch (this.H) {
            ...
            case 6: {
                ...
                if (this.as != 7 && this.as != 12 && (bv.b(this.B, this.C + 1) & 2) != 2) {
                    this.D = 0;
                    this.E = 0;
                    this.H = 4;
                    this.as = 7;
        ...
        if (this.bl) {
            this.as = 17;
            if (main.a.w % 4 == 0) {
                at.a(1, this.B, this.C + main.a.ae, 1);
            }
            if (this.aq && (var1_13 = System.currentTimeMillis()) - this.bo >= 1000L) {
                ...
                if (this.U < this.V) {
                    p.a("+" + this.V * (long)this.aC.k / 100L + " " + aw.eX, this.B, this.C - this.al - 20, 0, -1, 9);
                }
                if (this.T < this.W) {
                    p.a("+" + this.W * (long)this.aC.k / 100L + " " + aw.eY, this.B, this.C - this.al - 20, 0, -2, 10);
                }
                bt.a().c((byte)2);
            }
        }
        ...
        var1_14 = this;
        if (var1_14.bU == 934) {
            if (main.a.b - var1_14.eT > 0L) {
                ++var1_14.eS;
                if (var1_14.eS > var1_14.eW.length - 1) {
                    var1_14.eS = 0;
                    var1_14.eT = main.a.b + (long)ds.b(2000, 3500);
    ...
    private void ae() {
                ...
                if (this.ei[n2] != null) {
                    if (this.ei[n2].b != null) {
                        if (!this.ei[n2].e) {
                            ...
                            p.a(this.ei[n2].b.m, this.ei[n2].b.n - n3, this.I);
                            this.ei[n2].e = true;
                        }
                        ...
                        p.a(this.ei[n2].c.B, this.ei[n2].c.C - (this.ei[n2].c.al >> 1), this.I);
                        this.ei[n2].e = true;
                    }
                    ++this.ei[n2].a;
                    if (this.ei[n2].a >= this.ei[n2].d.a.length) {
                        this.ei[n2] = null;
                    }
                }
                ++n2;
        ...
        if (this.bZ >= 0 && this.ca != null && main.a.w % 2 == 0) {
            ++this.bZ;
    ...
    private void ah() {
        ...
        if (this.cf != null && (this.aU != null && this.c(this.aU) && this.aU.H == 14 || this.aQ != null && this.aQ.p == 0)) {
            if (!this.aq) {
        ...
        if ((fArray = this.D()) != null && this.cb >= 0 && this.cb <= fArray.length - 1) {
            if (fArray[this.cb].b != 0) {
                this.ef = p.y[fArray[this.cb].b - 1];
                this.ec = 0;
                this.dZ = 0;
                this.dW = 0;
            }
            if (fArray[this.cb].e != 0) {
                this.eg = p.y[fArray[this.cb].e - 1];
                this.ed = 0;
                this.ea = 0;
                this.dX = 0;
            }
            if (fArray[this.cb].h != 0) {
                this.eh = p.y[fArray[this.cb].h - 1];
                this.ee = 0;
                this.eb = 0;
                this.dY = 0;
            }
            ...
            if (fArray2 != null && fArray2[n2] != null && n2 >= 0 && n2 <= fArray2.length - 1 && fArray2[n2].k != 0) {
                ...
                if (n3 >= 100) {
                    ...
                    if (bq2 != null) {
                        ...
                        this.cd = new bj(this, n3 - 100, this.cg, this.B + (fArray2[n2].l - 10) * this.I, this.C + fArray2[n2].m + n5);
                        if (this.aC != null) {
                            if (this.aC.a.a == 1) {
                                bu.a();
                    ...
                    this.cc = new dq(this, p.v[n3 - 1]);
                    this.cc.a = 10;
                    this.cc.b = this.B + fArray2[n2].l;
                    this.cc.c = this.C + fArray2[n2].m;
                }
            }
            if ((this.aQ != null || !this.aq && this.aU != null || this.aq && this.aU != null && (this.c(this.aU) || this.y()) && this.cc == null && this.cd == null) && this.cb == fArray.length - 1) {
                this.E();
            }
            if (!this.aq) {
                bq bq3 = null;
                ...
                if (bq3 != null) {
                    if (ds.g(bq3.l() - this.B) < 10) {
                        this.B = bq3.l() > this.B ? (this.B -= 10) : (this.B += 10);
                    }
                    if (bq3.l() > this.B) {
                        this.I = 1;
                        return;
    ...
    private void an() {
        ...
        if (!(this.dP != 40 && this.dP != 50 || main.a.a)) {
            main.a.a().a(-1, this.B + 8, this.C);
            main.a.a().a(1, this.B - 8, this.C);
            this.e(1);
        }
        ...
        switch (this.K) {
            case 0: {
                ...
                if (this.Q < 13 || main.a.w % 4 != 0) break;
                at.a(132, this, 1);
                return;
            }
            case 1: {
                ...
                if (this.Q >= 13 && main.a.w % 12 == 0) {
                    at.a(114, this, 1);
                }
                if (this.Q < 13 || main.a.w % 25 != 0) break;
                at.a(131, this, 1);
                return;
            }
            case 2: {
    ...
    private void ao() {
        ...
        if (!this.aq && this.bP != null && (n2 = af.c(this.B - this.bP.a)) > n3) {
            this.ap();
        }
    ...
    private void ar() {
        ...
        if (!(!this.aq || this.B - this.bD == 0 && this.C - this.bE == 0 || ds.g(af.e().B - af.e().bD) <= 96 && ds.g(af.e().C - af.e().bE) <= 24)) {
            bt.a().g();
        }
    }
    ...
    private void at() {
        ...
        if (bl2) {
            ...
            if (ds.g(this.D) <= 4 && this.aq) {
                if (this.bP != null) {
                    n3 = af.c(this.B - this.bP.a);
                    this.as = n3 > (n2 = af.c(this.C - this.bP.b)) * 10 ? 8 : (n3 > n2 && n3 > 48 && n2 > 32 ? 8 : 7);
                } else {
                    if (this.E < 0) {
                        this.E = 0;
                    }
        ...
        if (this.aq) {
            ...
            if (af.c(this.B - this.bD) > 96 || af.c(this.C - this.bE) > 24) {
                bt.a().g();
            }
        }
    }
    ...
    private static void av() {
        if (aa.c[50].f == null) {
            ...
            if (inputStream != null) {
                ...
                aa.c[50].f.a = l.b(String.valueOf(string) + "/img.png");
            } else {
                bt.a().h(50);
            }
            aa.K.addElement("50");
    ...
    public final void b(en en2) {
        if (this.dt > p.j && this.dt < p.j + main.a.A) {
            if (this.aq) {
                if (this.dC || this.dA || this.dB) {
                    if (this.bt >= bs) {
                        Object object = String.valueOf(this.dT) + (this.bt - bs) + "_1";
                        if ((object = l.d((String)object)) != null) {
                            ((df)object).a(this.dq / 2 % ((df)object).c, this.dt, this.du + this.bS, this.dr, 3, en2);
                        }
                        return;
                    }
                    if (this.bx) {
                    ...
                    if (this.ds == 0) {
                        ...
                        en2.a(di, 0, this.do[this.dp] * 40, 50, 40, this.dr, this.dt + this.dv, this.du + this.dw + this.bS, 0);
                        return;
                    }
                    if (this.ds == 1) {
                        if (!this.bv) {
                            en2.a(dg, 0, this.do[this.dp] * 40, 50, 40, this.dr, this.dt + this.dv, this.du + this.dw + this.bS, 0);
                            return;
                        }
        ...
        if (this.aq) {
            ...
            while (n4 < hArray.length) {
                if (hArray[n4] != null && (hArray[n4].b.b == 24 || hArray[n4].b.b == 23)) {
                    n2 = hArray[n4].b.g >= 0 ? (int)((short)(bs + hArray[n4].b.g)) : (int)hArray[n4].b.a;
                    n3 = 1;
                    break;
                }
                ++n4;
    ...
    public final void a(ci ci2, int n2) {
        ...
        if (this.aq) {
            ...
            this.aC.f = l2;
            this.T = this.aC.a.d == 2 ? 1L : (this.aC.a.d != 1 ? (this.T -= (long)this.aC.i) : (this.T -= (long)this.aC.i * this.W / 100L));
            --af.e().bf;
            p.j().bB = true;
            p.j().bA = 0L;
            if (this.T < 0L) {
    ...
    public static void A() {
        p.j().aX = 0;
        af.e().a(p.u[af.e().aC.b], bv.a(af.e().B, af.e().C, 2) ? 0 : 1);
    }
    ...
    public final void b(ci ci2, int n2) {
        ...
        if (ci2.a >= 0 && ci2.a <= 6) {
            ...
            int n5 = ds.b(0, (this.cE == 1 ? 105 : ci2.a) - (this.cE == 1 ? 105 : 28) + 4) - 1;
            if (n5 < 0) {
                n5 = 0;
            }
            if (n5 > 6) {
            ...
            this.cg = p.u[n5 + (this.cE == 1 ? 105 : 28)];
        } else if (ci2.a >= 63 && ci2.a <= 69) {
            int n6 = ds.b(0, ci2.a - 63 + 4) - 1;
            if (n6 < 0) {
                n6 = 0;
            }
            if (n6 > 6) {
    ...
    public final void E() {
        if (this.aq) {
            ...
            if (ci2 != null) {
                ...
                while (n2 < el2.size()) {
                    this.ei[n2] = new cu();
                    this.ei[n2].d = p.y[ci2.b - 1];
                    if (!this.w()) {
                        this.ei[n2].b = (aa)el2.elementAt(n2);
                    }
                    ++n2;
                }
                n2 = 0;
                while (n2 < el3.size()) {
                    ...
                    this.ei[n2 + el2.size()].d = p.y[ci2.b - 1];
                    this.ei[n2 + el2.size()].c = (af)el3.elementAt(n2);
                    ++n2;
                }
                n2 = 0;
                if (this.aQ != null) {
    ...
    public void a(en en2) {
        ...
        if (this.v != null) {
            ...
            int n3 = 32;
            int n4 = 32;
            int n5 = n2 = main.a.w % 10 > 5 ? 1 : 0;
            if (((dk)object).l > 0) {
                n3 = ((dk)object).m;
                n4 = ((dk)object).n;
                n2 = 0;
            }
            bl.a(en3, ((dk)object).a, ((dk)object).c, ((dk)object).i, ((dk)object).e + 3 + n2, n3, n4, ((dk)object).b == 1 ? 0 : 2, cj.f);
        }
        en3 = en2;
        object = this;
        if (((af)object).dt > p.j && ((af)object).dt < p.j + main.a.A) {
            if (((af)object).aq) {
                if (((af)object).dC || ((af)object).dA || ((af)object).dB) {
                    if (((af)object).bt >= bs) {
                        String string2 = String.valueOf(((af)object).dT) + (((af)object).bt - bs) + "_0";
                        df df3 = l.d(string2);
                        if (df3 != null) {
                            df3.a(((af)object).dq / 2 % df3.c, ((af)object).dt, ((af)object).du + ((af)object).bS, ((af)object).dr, 3, en3);
                        }
                    } else if (!((af)object).bx) {
                        if (((af)object).bw) {
                            en3.a(dn, 0, ((af)object).do[((af)object).dp] * 60, 60, 60, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                        } else if (((af)object).ds == 2) {
                            if (!((af)object).bv) {
                                en3.a(dh, 0, ((af)object).do[((af)object).dp] * 40, 50, 40, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                            } else {
                                en3.a(dl, 0, ((af)object).do[((af)object).dp] * 40, 50, 40, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                            }
                        } else if (((af)object).ds == 1) {
                            if (!((af)object).bv) {
                                en3.a(df, 0, ((af)object).do[((af)object).dp] * 40, 50, 40, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                            } else {
                                en3.a(dj, 0, ((af)object).do[((af)object).dp] * 40, 50, 40, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                            }
                        }
                    }
                }
            } else if (!((af)object).aq) {
                if (((af)object).bt >= bs) {
                    String string3 = String.valueOf(((af)object).dT) + (((af)object).bt - bs) + "_0";
                    df df4 = l.d(string3);
                    if (df4 != null) {
                        df4.a(((af)object).dq / 2 % df4.c, ((af)object).dt, ((af)object).du + ((af)object).bS, ((af)object).dr, 3, en3);
                    }
                } else if (!((af)object).bx) {
                    if (((af)object).bw) {
                        en3.a(dn, 0, ((af)object).do[((af)object).dp] * 60, 60, 60, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                    } else if (((af)object).dB) {
                        if (((af)object).ds == 2) {
                            if (!((af)object).bv) {
                                en3.a(dh, 0, ((af)object).do[((af)object).dp] * 40, 50, 40, ((af)object).dr, ((af)object).dt + ((af)object).dv, ((af)object).du + ((af)object).dw + ((af)object).bS, 0);
                            } else {
        ...
        en3 = en2;
        object = this;
        if (!(((af)object).aq && !cX || ((af)object).cV >= 0 || ((af)object).H != 1 && ((af)object).H != 6 || l.d() - ((af)object).eo <= 0L || ((af)object).cF || ((af)object).Q < 16)) {
            int n6 = 7598;
            if (((af)object).Q >= 19) {
                n6 = 7676;
            }
            ...
            if (n6 != -1) {
                ...
                if (eg2 == null) {
                    ...
                    n6 = main.a.w / 4 % 4 * (en.b(eg2.a) / 4);
                    en3.a(eg2.a, 0, n6, en.a(eg2.a), en.b(eg2.a) / 4, 0, ((af)object).B, ((af)object).C + 2, 33);
                }
            }
        }
        en3 = en2;
        object = this;
        if (!(((af)object).aq && !cW || ((af)object).cV < 0 || ((af)object).H != 1 && ((af)object).H != 6 || main.a.G.a || l.d() - ((af)object).eo <= 0L || (df2 = l.d(string = String.valueOf(((af)object).eY) + ((af)object).cV + "_0")) == null)) {
            df2.a(main.a.w / 4 % df2.c, ((af)object).B, ((af)object).C, ((af)object).I == 1 ? 0 : 2, 33, en3);
        }
        this.h(en2);
        en3 = en2;
        object = this;
        if (((af)object).cY != -1) {
            if (((af)object).eZ != null) {
                ((af)object).eZ.a(main.a.w / 4 % ((af)object).eZ.c, ((af)object).B, ((af)object).C + 3, ((af)object).I == 1 ? 0 : 2, 33, en3);
            } else {
                ((af)object).eZ = l.d(String.valueOf(((af)object).fb) + ((af)object).cY + "_0");
            }
        }
        this.e(en2);
        if (this.c > 0) {
        ...
        en3 = en2;
        object = this;
        av av2 = p.x[super.h(((af)object).bU)];
        int n7 = bC[((af)object).as][0][2] - av2.a[af.bC[((af)object).as][0][0]].c + 5;
        if (!(((af)object).bc && !((af)object).aq || !((af)object).aq && bv.l == 113 && ((af)object).C >= 360)) {
            if (((af)object).aq) {
                ((af)object).a(en3, ((af)object).B, ((af)object).C - (n7 += 5) + 3);
            } else {
                boolean bl2;
                boolean bl3 = af.dD.ai != null && ((af)object).ah == af.dD.ai.a;
                boolean bl4 = ((af)object).aN == 3 || ((af)object).aN == 5;
                boolean bl5 = bl2 = ((af)object).aN == 4;
                if (((af)object).ag.startsWith("$")) {
                    ((af)object).ag = ((af)object).ag.substring(1);
                    ((af)object).ev = true;
                }
                if (((af)object).ag.startsWith("#")) {
                    ((af)object).ag = ((af)object).ag.substring(1);
                ...
                if (af.e().aU != null && af.e().aU.equals(object)) {
                    ((af)object).a(en3, ((af)object).B, ((af)object).C - (n7 += 5) + 3);
                }
                n7 += di.k.a();
                di di2 = di.H;
                if (((af)object).ev || ((af)object).ew) {
                    di2 = di.J;
                } else if (bl4) {
                    di2 = di.B;
                } else if (bl2) {
                ...
                if (bv.l == 170) {
                    if (((af)object).bz == 2325) {
                        di2 = di.q;
                    } else if (((af)object).bz == 2323) {
                        di2 = di.p;
                    }
                }
                if ((((af)object).i || bl4 || bl2) && !bl3) {
                    if (l.c == 1) {
                        di2.a(en3, ((af)object).ag, ((af)object).B, ((af)object).C - n7, 2, di.E);
                    } else {
                        di2.a(en3, ((af)object).ag, ((af)object).B, ((af)object).C - n7, 2);
                    }
                    n7 += di.k.a();
                }
                if (bl3) {
                    if (af.e().aU != null && af.e().aU.equals(object)) {
                        di2.a(en3, ((af)object).ag, ((af)object).B, ((af)object).C - n7, 2, di.E);
                    } else if (((af)object).aU == null) {
                        di2.a(en3, ((af)object).ag, ((af)object).B - 10, ((af)object).C - n7 + 3, 0, di.o);
                        ((af)object).a(en3, ((af)object).B - 16, ((af)object).C - n7 + 10);
                    }
                }
            }
        }
        ...
        object = this;
        if (((af)object).cY != -1) {
            if (((af)object).fa != null) {
                ((af)object).fa.a(main.a.w / 4 % ((af)object).fa.c, ((af)object).B, ((af)object).C + 8, ((af)object).I == 1 ? 0 : 2, 33, en3);
            } else {
                ((af)object).fa = l.d(String.valueOf(((af)object).fb) + ((af)object).cY + "_1");
            }
        }
        en3 = en2;
        object = this;
        if (cX) {
            if (((af)object).H == 1 || ((af)object).H == 6) {
                if (l.d() - ((af)object).eo > 0L) {
                    if (((af)object).cF) {
                        if (main.a.w % 2 == 0) {
                            ++((af)object).ep;
                        }
                        ...
                        en3.a(main.a.S[((af)object).ep], ((af)object).B, ((af)object).C + 9, 33);
                    } else {
                        if (((af)object).Q >= 14 && !main.a.a) {
                            boolean bl6 = false;
                            if (l.d() - ((af)object).eo > -1000L && ((af)object).eq) {
                                bl6 = true;
                                ((af)object).eq = false;
                            }
                            if (l.d() - ((af)object).eo > -500L && ((af)object).er) {
                                bl6 = true;
                                ((af)object).er = false;
                            }
                            if (bl6) {
                                main.a.a().a(-1, ((af)object).B - -8, ((af)object).C);
                                main.a.a().a(1, ((af)object).B - 8, ((af)object).C);
                                super.e(1);
                            }
                        }
                        if (((af)object).Q == 14) {
                            ...
                            en3.a(main.a.R[((af)object).ep], ((af)object).B, ((af)object).C + 9, 33);
                        } else if (((af)object).Q == 15) {
                            if (main.a.w % 2 == 0) {
                                ++((af)object).ep;
                            }
                            if (((af)object).ep > 6) {
                            ...
                            en3.a(main.a.S[((af)object).ep], ((af)object).B, ((af)object).C + 9, 33);
                        } else if (((af)object).Q >= 16) {
                            int n8 = -1;
                            if (((af)object).Q >= 16 && ((af)object).Q < 22) {
                                n8 = 7599;
                            }
                            if (n8 != -1) {
                                eg eg3 = bl.c[7599];
                                if (eg3 == null) {
                                    ...
                                    n8 = main.a.w / 4 % 4 * (en.b(eg3.a) / 4);
                                    en3.a(eg3.a, 0, n8, en.a(eg3.a), en.b(eg3.a) / 4, 0, ((af)object).B, ((af)object).C + 2, 33);
                                }
                            }
                        }
                    }
        ...
        en3 = en2;
        object = this;
        if ((!((af)object).aq || cW) && ((af)object).cV >= 0) {
            if (((af)object).H == 1 || ((af)object).H == 6) {
                if (!main.a.G.a && !main.a.a) {
                    String string4;
                    df df5;
                    boolean bl7 = false;
                    if (l.d() - ((af)object).eo > -1000L && ((af)object).eq) {
                    ...
                    if (l.d() - ((af)object).eo > 0L && (df5 = l.d(string4 = String.valueOf(((af)object).eY) + ((af)object).cV + "_1")) != null) {
                        df5.a(main.a.w / 4 % df5.c, ((af)object).B, ((af)object).C + 2, ((af)object).I == 1 ? 0 : 2, 33, en3);
                    }
                }
            } else {
                ((af)object).eo = l.d() + 1500L;
        ...
        en3 = en2;
        object = this;
        if (!((af)object).db && ((af)object).bA != 0 && ((af)object).bB != 0 && ((af)object).H != 14) {
            int n9 = 0;
            int n10 = ((af)object).B - 30;
            int n11 = ((af)object).C - 15;
            if (ds.g(((af)object).C - ((af)object).bB) > 150) {
                if (((af)object).C > ((af)object).bB) {
                    n9 = 7;
                    n10 = ((af)object).B;
                    n11 = ((af)object).C - 15 - 60;
                } else {
                    n9 = 5;
                    n10 = ((af)object).B;
                    n11 = ((af)object).C - 15 + 60;
                }
            } else if (((af)object).B > ((af)object).bA) {
                n9 = 2;
            } else if (((af)object).B <= ((af)object).bA) {
                n10 = ((af)object).B + 30;
            }
            if (main.a.w % 10 >= 5) {
                if (ds.g(((af)object).B - ((af)object).bA) > 100) {
                    en3.a(p.bw, 0, 0, 13, 16, n9, n10, n11, cj.f);
                    return;
                }
                if (ds.g(((af)object).B - ((af)object).bA) < 50) {
                    en3.a(g.i, ((af)object).bA + -30, ((af)object).bB - 60 + 5, 0);
                }
            }
        }
    }
    ...
    private void f(en en2) {
            ...
            while (n2 < this.ei.length) {
                if (this.ei[n2] != null) {
                    if (this.ei[n2].b != null) {
                        ...
                        bl.b(en2, this.ei[n2].a(), this.ei[n2].b.m, n3, 0, 33);
                    } else if (this.ei[n2].c != null) {
                        bl.b(en2, this.ei[n2].a(), this.ei[n2].c.B, this.ei[n2].c.C, 0, 33);
                    }
                }
                ++n2;
            }
        ...
        if (this.bZ >= 0 && this.ca != null) {
            bl.b(en2, this.ca.a[this.bZ].c, this.B + this.ca.a[this.bZ].a, this.C + this.ca.a[this.bZ].b, 0, 3);
        }
    }
    ...
    public final void a(en en2, int n2, int n3) {
        ...
        if (!this.aq) {
            en2.a(aa.R, 0, 6 * (9 - n4), 9, 6, 0, n2, n3 - di.k.a() - 6, 3);
        }
        if (this.aN != 0 || af.e().by != 0 && this.by != 0 && (this.by == 8 || af.e().by == 8 || this.by != af.e().by)) {
            this.es = (int)(this.U * 100L / this.V * (long)this.et) / 100;
            n4 = (int)(this.U * 100L / this.V);
            this.eu = n4 < 30 ? p.aH : (n4 < 60 ? p.aI : p.aK);
            int n5 = en.a(p.aJ);
            int n6 = en.b(p.aJ);
            n4 = n5 * n4 / 100;
            en2.a(p.aJ, n2 - (n5 >> 1), n3 - 1, 20);
            if (this.es >= 5 || main.a.w % 6 < 3) {
                en2.a(this.eu, 0, 0, n4, n6, 0, n2 - (n5 >> 1), n3 - 1, 20);
            }
        }
    }

    public final void c(en en2) {
        if (this.ck) {
            return;
        }
        if (this.bU == 377) {
        ...
        byte by2 = bv.i;
        if (!(bv.l >= 114 && bv.l <= 120 || bv.l == 127 || bv.l == 128 || bv.a(this.cl + by2 / 2, this.cm + 1, 4))) {
    ...
    private void g(en en2) {
        block8: {
            try {
                if (this.dc) {
                    this.a(en2, this.dd, this.de, this.I, this.as, false);
                    return;
                }
                if (this.bc) {
                    if (this.aq) {
                        if (main.a.w % 50 == 48 || main.a.w % 50 == 90) {
    ...
    public final void a(en en2, short[] sArray, int n2, int n3, int n4, boolean bl2) {
        int n5 = 0;
        int n6 = 0;
        if (this.H == 6) {
            n5 = 8;
    ...
    public final boolean a(int n2) {
        ...
        int n3 = 0;
        while (n3 < bC.length) {
            if (n2 == av2.a[af.bC[n3][0][0]].a) {
                return true;
            }
            if (n2 == av3.a[af.bC[n3][1][0]].a) {
                return true;
            }
            if (n2 == av4.a[af.bC[n3][2][0]].a) {
                return true;
            }
            ++n3;
        }
    ...
    public final void a(en en2, int n2, int n3, int n4) {
        av av2 = p.x[this.bU];
        bl.b(en2, av2.a[af.bC[0][0][0]].a, n2, n3, 0, 10);
    }

    public final void b(en en2, int n2, int n3, int n4) {
        av av2 = p.x[this.bU];
        bl.b(en2, av2.a[af.bC[0][0][0]].a, n2 + bC[0][0][1] + av2.a[af.bC[0][0][0]].b - 3, n3 + 3, n4, 36);
    }

    public final void a(en en2, int n2, int n3, int n4, int n5, boolean bl2) {
        en en3;
        int n6;
        this.ey = p.x[this.bU];
        this.ez = p.x[this.bV];
        ...
        if (this.H == 14) {
            ...
            bl.b(en2, 834, n2, n3 - bC[n5][2][2] + this.eA.a[af.bC[n5][2][0]].c - 2 + n4, n7, cj.a);
            bl.b(en2, 79, n2, n3 - this.al - 8, 0, 33);
            bl.b(en2, this.ey.a[af.bC[n5][0][0]].a, n2 + (bC[n5][0][1] + this.ey.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + this.ey.a[af.bC[n5][0][0]].c, n7, n6);
            this.b(en2, n5, n3 - bC[n5][2][2] + this.eA.a[af.bC[n5][2][0]].c);
            if (af.g(this.bU)) {
                av av2 = p.x[this.h(this.bU)];
                bl.b(en2, av2.a[af.bC[n5][0][0]].a, n2 + (bC[n5][0][1] + av2.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + av2.a[af.bC[n5][0][0]].c, n7, n6);
            } else {
                bl.b(en2, this.ey.a[af.bC[n5][0][0]].a, n2 + (bC[n5][0][1] + this.ey.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + this.ey.a[af.bC[n5][0][0]].c, n7, n6);
            }
            int n11 = n3 - bC[n5][2][2] + this.eA.a[af.bC[n5][2][0]].c;
            int n12 = n5;
            en3 = en2;
            af af2 = this;
            try {
                if (af2.cZ != -1) {
                    if (af.i(n12)) {
                        if (af2.ff != null) {
                            af2.ff.a(main.a.w / 4 % af2.ff.c, af2.B + fj[n12][0] * (af2.I == 1 ? 1 : -1), n11 + fj[n12][1], af2.I == 1 ? 0 : 2, 33, en3);
                        } else {
                            af2.ff = l.d(String.valueOf(af2.fh) + af2.fi + af2.cZ);
                        }
                    } else if (af2.fd != null) {
                        af2.fd.a(main.a.w / 4 % af2.fd.c, af2.B + fj[n12][0] * (af2.I == 1 ? 1 : -1), n11 + fj[n12][1], af2.I == 1 ? 0 : 2, 33, en3);
                    } else {
            ...
            this.a(en2, n2 + (bC[n5][0][1] + this.ey.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + this.ey.a[af.bC[n5][0][0]].c, n7, n6);
        } else {
            this.b(en2, n5, n3 - bC[n5][2][2] + this.eA.a[af.bC[n5][2][0]].c);
            try {
                if (af.g(this.bU)) {
                    av av3 = p.x[this.h(this.bU)];
                    bl.b(en2, av3.a[af.bC[n5][0][0]].a, n2 + (bC[n5][0][1] + av3.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + av3.a[af.bC[n5][0][0]].c, n7, n6);
                } else {
                    bl.b(en2, this.ey.a[af.bC[n5][0][0]].a, n2 + (bC[n5][0][1] + this.ey.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + this.ey.a[af.bC[n5][0][0]].c, n7, n6);
                }
                bl.b(en2, this.ez.a[af.bC[n5][1][0]].a, n2 + (bC[n5][1][1] + this.ez.a[af.bC[n5][1][0]].b) * n10, n3 - bC[n5][1][2] + this.ez.a[af.bC[n5][1][0]].c, n7, n6);
                bl.b(en2, this.eA.a[af.bC[n5][2][0]].a, n2 + (bC[n5][2][1] + this.eA.a[af.bC[n5][2][0]].b) * n10, n3 - bC[n5][2][2] + this.eA.a[af.bC[n5][2][0]].c, n7, n6);
                this.a(en2, n2 + (bC[n5][0][1] + this.ey.a[af.bC[n5][0][0]].b) * n10, n3 - bC[n5][0][2] + this.ey.a[af.bC[n5][0][0]].c, n7, n6);
            }
            catch (Exception exception) {}
        }
        int n13 = this.al = this.cE == 1 || this.cL ? 60 : bC[0][0][2] + this.ey.a[af.bC[0][0][0]].c + 10;
        int n12 = ds.g(this.ey.a[af.bC[n5][0][0]].c) >= 22 ? (this.ey.a[af.bC[n5][0][0]].c < 0 ? this.ey.a[af.bC[n5][0][0]].c + 5 : this.ey.a[af.bC[n5][0][0]].c - 5) : this.ey.a[af.bC[n5][0][0]].c;
        this.eB = n3 - bC[n5][0][2] + n12;
        if (!(this.H != 1 || this.J <= 0 || this.r || this.z() || this.cG || this.cf != null || n5 == 23 || this.bX >= 0 || (main.a.w + this.J) % 30 != 0 && !this.bk)) {
            en2.a(this.K == 1 ? l : k, n2 + n10 * -2, n3 - 32 + (this.K == 1 ? 10 : 11) - n5, n9);
        }
        if (this.dI != null) {
            this.dI.a(en2);
        }
        ...
        if (af3.I == 1) {
            if (af3.by != 0 && af3.by != -1) {
                ...
                bl.b(en3, af3.bz, af3.B - 10, af3.C - af3.al - 30 + (main.a.w % 20 > 10 ? main.a.w % 4 / 2 : 0), 2, 0);
                return;
            }
        } else if (af3.by != 0 && af3.by != -1) {
            boolean cfr_ignored_1 = af3.aq;
            bl.b(en3, af3.bz, af3.B, af3.C - af3.al - 30 + (main.a.w % 20 > 10 ? main.a.w % 4 / 2 : 0), 0, 0);
        }
    }

    public final void d(en en2) {
        this.dP = 0;
        f[] fArray = this.D();
        ...
        if (this.I == 1) {
            if (this.ef != null) {
                ...
                bl.b(en2, this.ef.a[this.dW].c, this.B + this.dZ + this.ef.a[this.dW].a, this.C + this.ec + this.ef.a[this.dW].b, 0, 3);
                ++this.dW;
            ...
            if (this.eg != null) {
                ...
                if (this.ed == 0) {
                    this.ed = fArray[this.cb].g;
                }
                bl.b(en2, this.eg.a[this.dX].c, this.B + this.ea + this.eg.a[this.dX].a, this.C + this.ed + this.eg.a[this.dX].b, 0, 3);
                ++this.dX;
            ...
            if (this.eh != null) {
                ...
                bl.b(en2, this.eh.a[this.dY].c, this.B + this.eb + this.eh.a[this.dY].a, this.C + this.ee + this.eh.a[this.dY].b, 0, 3);
                ++this.dY;
            ...
            if (this.ef != null) {
                ...
                bl.b(en2, this.ef.a[this.dW].c, this.B - this.dZ - this.ef.a[this.dW].a, this.C + this.ec + this.ef.a[this.dW].b, 2, 3);
                ++this.dW;
                if (this.dW >= this.ef.a.length) {
                    this.ef = null;
                    this.dW = 0;
            ...
            if (this.eg != null) {
                ...
                bl.b(en2, this.eg.a[this.dX].c, this.B - this.ea - this.eg.a[this.dX].a, this.C + this.ed + this.eg.a[this.dX].b, 2, 3);
                ++this.dX;
                if (this.dX >= this.eg.a.length) {
                    this.eg = null;
                    this.dX = 0;
            ...
            if (this.eh != null) {
                ...
                bl.b(en2, this.eh.a[this.dY].c, this.B - this.eb - this.eh.a[this.dY].a, this.C + this.ee + this.eh.a[this.dY].b, 2, 3);
                ++this.dY;
                if (this.dY >= this.eh.a.length) {
                    this.eh = null;
                    this.dY = 0;
    ...
    private void ay() {
        ...
        block60: {
            block61: {
                block57: {
                    if (af.e().cf != null || af.e().cc != null || af.e().cd != null) {
                        this.eD = 200;
                        return;
                    }
                    if (this.eD > 0) {
                    ...
                    n8 = p.j + main.a.A + 10;
                    n7 = p.k;
                    n6 = p.k + main.a.B - p.h + 10;
                    if (cn) {
                        if (this.aQ != null && this.aQ.p != 1 && this.aQ.p != 0 && n9 <= this.aQ.m && this.aQ.m <= n8 && n7 <= this.aQ.n && this.aQ.n <= n6 || this.aT != null && n9 <= this.aT.B && this.aT.B <= n8 && n7 <= this.aT.C && this.aT.C <= n6 || this.aU != null && n9 <= this.aU.B && this.aU.B <= n8 && n7 <= this.aU.C && this.aU.C <= n6 || this.aV != null && n9 <= this.aV.a && this.aV.a <= n8 && n7 <= this.aV.b && this.aV.b <= n6) {
                            return;
                        }
                        cn = false;
                    }
                    ...
                    if (this.aT == null) {
                        n5 = 0;
                        while (n5 < p.G.size()) {
                            bq2 = (do)p.G.elementAt(n5);
                            if (bq2.H != 15) {
                                n4 = Math.abs(af.e().B - bq2.B);
                                n2 = n4 > (n3 = Math.abs(af.e().C - bq2.C)) ? n4 : n3;
                                n9 = af.e().B - 80;
                                n8 = af.e().B + 80;
                                n7 = af.e().C - 30;
                                n6 = af.e().C + 30;
                    ...
                    while (n5 < p.E.size()) {
                        block58: {
                            block59: {
                                bq2 = (ce)p.E.elementAt(n5);
                                n4 = Math.abs(af.e().B - ((ce)bq2).a);
                                int n11 = n2 = n4 > (n3 = Math.abs(af.e().C - ((ce)bq2).b)) ? n4 : n3;
                                if (n4 > 48 || n3 > 48 || this.aV != null && n2 >= nArray[3]) break block58;
                                if (p.j().aX == 0) break block59;
                                p.j();
                                if (p.h() && ((ce)bq2).e.b != 9) break block58;
                            }
                            this.aV = bq2;
                            nArray[3] = n2;
                        }
                ...
                if (n9 <= this.aV.a && this.aV.a <= n8 && n7 <= this.aV.b && this.aV.b <= n6) break block61;
                this.aV = null;
                n5 = 0;
                while (n5 < p.E.size()) {
                    block62: {
                        block63: {
                            bq2 = (ce)p.E.elementAt(n5);
                            n4 = Math.abs(af.e().B - ((ce)bq2).a);
                            int n12 = n2 = n4 > (n3 = Math.abs(af.e().C - ((ce)bq2).b)) ? n4 : n3;
                            if (n9 > ((ce)bq2).a || ((ce)bq2).a > n8 || n7 > ((ce)bq2).b || ((ce)bq2).b > n6 || this.aV != null && n2 >= nArray[3]) break block62;
                            if (p.j().aX == 0) break block63;
                            p.j();
                            if (p.h() && ((ce)bq2).e.b != 9) break block62;
                        }
                        this.aV = bq2;
                        nArray[3] = n2;
                    }
        ...
        n9 = af.e().B - af.e().aa() - 10;
        n8 = af.e().B + af.e().aa() + 10;
        n7 = af.e().C - af.e().ab() - n10 - 20;
        n6 = af.e().C + af.e().ab() + 20;
        if (n6 > af.e().C + 30) {
            n6 = af.e().C + 30;
        }
        if (this.aQ == null) {
            n5 = 0;
            while (n5 < p.F.size()) {
                bq2 = (aa)p.F.elementAt(n5);
                n4 = Math.abs(af.e().B - ((aa)bq2).m);
                int n13 = n2 = n4 > (n3 = Math.abs(af.e().C - ((aa)bq2).n)) ? n4 : n3;
        ...
        } else if (this.aQ.p == 1 || this.aQ.p == 0 || n9 > this.aQ.m || this.aQ.m > n8 || n7 > this.aQ.n || this.aQ.n > n6) {
            this.aQ = null;
            n5 = 0;
            while (n5 < p.F.size()) {
                bq2 = (aa)p.F.elementAt(n5);
                n4 = Math.abs(af.e().B - ((aa)bq2).m);
                int n14 = n2 = n4 > (n3 = Math.abs(af.e().C - ((aa)bq2).n)) ? n4 : n3;
                if (n9 <= ((aa)bq2).m && ((aa)bq2).m <= n8 && n7 <= ((aa)bq2).n && ((aa)bq2).n <= n6 && (this.aQ == null || n2 < nArray[0])) {
                    this.aQ = bq2;
                    nArray[0] = n2;
                }
        ...
        if (this.aU == null) {
            n5 = 0;
            while (n5 < p.D.size()) {
                bq2 = (af)p.D.elementAt(n5);
                if (bq2.H != 15 && !bq2.bc && this.co == 0 && this.cp == 0) {
                    n4 = Math.abs(af.e().B - bq2.B);
                    int n15 = n2 = n4 > (n3 = Math.abs(af.e().C - bq2.C)) ? n4 : n3;
            ...
            while (n5 < p.D.size()) {
                ...
                if (bq2.H != 15 && !bq2.bc && this.co == 0 && this.cp == 0) {
                    n4 = Math.abs(af.e().B - bq2.B);
                    int n16 = n2 = n4 > (n3 = Math.abs(af.e().C - bq2.C)) ? n4 : n3;
                    if (n9 <= bq2.B && bq2.B <= n8 && n7 <= bq2.C && bq2.C <= n6 && (this.aU == null || n2 < nArray[2])) {
                        this.aU = bq2;
                        nArray[2] = n2;
                    }
    ...
    public static boolean a(af af2) {
        int n2 = p.j;
        int n3 = p.j + main.a.A;
        int n4 = p.k + 10;
        int n5 = p.k + p.e;
    ...
    public final void J() {
        bq bq2;
        if ((af.e().cf != null || af.e().cc != null || af.e().cd != null || af.e().D() != null) && this.aW.size() == 0) {
            return;
        }
        this.aW.removeAllElements();
        int n2 = 0;
        int n3 = p.j + 10;
        int n4 = p.j + main.a.A - 10;
        int n5 = p.k + 10;
        int n6 = p.k + p.e;
        int n7 = 0;
        while (n7 < p.D.size()) {
            bq2 = (af)p.D.elementAt(n7);
            if (((af)bq2).H != 15 && !((af)bq2).bc && n3 <= ((af)bq2).B && ((af)bq2).B <= n4 && n5 <= ((af)bq2).C && ((af)bq2).C <= n6 && ((af)bq2).J != -114 && (bv.l != 129 || bv.l == 129 && af.e().C > 264)) {
        ...
        n7 = 0;
        while (n7 < p.E.size()) {
            bq2 = (ce)p.E.elementAt(n7);
            if (n3 <= ((ce)bq2).a && ((ce)bq2).a <= n4 && n5 <= ((ce)bq2).b && ((ce)bq2).b <= n6) {
                this.aW.addElement(bq2);
        ...
        while (n7 < p.F.size()) {
            bq2 = (aa)p.F.elementAt(n7);
            if (((aa)bq2).p != 1 && ((aa)bq2).p != 0 && n3 <= ((aa)bq2).m && ((aa)bq2).m <= n4 && n5 <= ((aa)bq2).n && ((aa)bq2).n <= n6) {
                this.aW.addElement(bq2);
        ...
        n7 = 0;
        while (n7 < p.G.size()) {
            bq2 = (do)p.G.elementAt(n7);
            if (((af)bq2).H != 15 && n3 <= ((af)bq2).B && ((af)bq2).B <= n4 && n5 <= ((af)bq2).C && ((af)bq2).C <= n6) {
                this.aW.addElement(bq2);
    ...
    public final void a(short s2, short s3) {
        ...
        if (this.aq) {
            ...
            while (n2 < p.D.size()) {
                ...
                ((af)p.D.elementAt(n2)).bb = -9999;
                ++n2;
            }
            if (main.a.G != null && main.a.G.ai != null) {
                main.a.G.ai = null;
            }
    ...
    public final boolean M() {
        ...
        while (n2 < this.aF.length) {
            if (this.aF[n2] != null && this.aF[n2].b.b == 6) {
                bt.a().a((byte)0, (byte)1, (byte)-1, this.aF[n2].b.a);
                return true;
            }
            ++n2;
        }
    ...
    public final boolean c(af af2) {
        if (af2 == null || af.e().aC == null || af.e().aC.a.e == 2 || af.e().aC.a.e == 4 && af2.H != 14 && af2.H != 5) {
            return false;
        }
        return (af2.aN == 3 && af.e().aN == 3 || af.e().aN == 5 || af2.aN == 5 || af.e().aN == 1 && af2.aN == 1 || af.e().aN == 4 && af2.aN == 4 || af.e().ba >= 0 && af.e().ba == af2.J || af.e().bb >= 0 && af.e().bb == af2.J && !af.aB() || af2.bb >= 0 && af2.bb == af.e().J && !af.aB() || af.e().by == 8 && af2.by != 0 || af.e().by != 0 && af2.by == 8 || af.e().by != af2.by && af.e().by != 0 && af2.by != 0) && af2.H != 14 && af2.H != 5;
    }
    ...
    public static void N() {
        ...
        while (n2 < af.e().aF.length) {
            if (af.e().aF[n2] != null && af.e().aF[n2].b.b == 8) {
                af.e().aF[n2] = null;
            }
            ++n2;
        }
    ...
    private void b(en en2, int n2, int n3) {
        try {
            if (this.cZ == -1) {
                return;
            }
            if (af.i(n2)) {
                if (this.fe != null) {
                    this.fe.a(main.a.w / 4 % this.fe.c, this.B + fj[n2][0] * (this.I == 1 ? 1 : -1), n3 + fj[n2][1], this.I == 1 ? 0 : 2, 33, en2);
                    return;
                }
            ...
            if (this.fc != null) {
                this.fc.a(main.a.w / 4 % this.fc.c, this.B + fj[n2][0] * (this.I == 1 ? 1 : -1), n3 + fj[n2][1], this.I == 1 ? 0 : 2, 33, en2);
                return;
            }
    ...
    public final void a(short s2, boolean bl2, byte by2, byte by3, byte by4, short s3, byte by5) {
        ...
        if (s2 == 24) {
            p.a(18, 0, by3, this.Z(), null, 3, s3, (short)0);
            p.a(21, 0, by3, this.Z(), null, 1, s3, (short)0);
        } else if (s2 == 25) {
            p.a(19, 0, by3, this.Z(), null, 3, s3, (short)0);
            p.a(22, 0, by3, this.Z(), null, 1, s3, (short)0);
        } else if (s2 == 26) {
            p.a(20, 0, by3, this.Z(), null, 3, s3, (short)0);
            p.a(23, 0, by3, this.Z(), null, 1, s3, (short)0);
        }
        if (this.fm == 1) {
            if (!this.fk) {
    ...
    public final void a(int n2, short s2, bk bk2, short s3, short s4, byte by2, bk[] bkArray, byte by3) {
        ...
        if (this.fn == 24) {
            p.a(18, 1, by2, this, null, 3, s3, (short)0);
            p.a(24, 0, by2, this, this.ft, 1, s3, s4);
        }
        if (this.fn == 25) {
            p.a(19, 0, by2, this, null, 3, s3, (short)0);
            p.a(25, 0, by2, this, this.ft, 1, s3, s4);
        }
        if (this.fn == 26) {
            p.a(20, 0, by2, this, null, 3, s3, (short)0);
            p.a(26, by3, by2, bk2.b, bk2.c, 1, 0, s3, bkArray);
        }
    }
    ...
    public final boolean b(int n2) {
        if (this.aH != null) {
            n2 = 0;
            while (n2 < this.aH.length) {
                if (this.aH[n2] != null && this.aH[n2].b != null && this.aH[n2].b.a == 1265) {
                    return true;
                }
                ++n2;
            }
